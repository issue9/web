...
func (doc *Parser) addRequestBody(o *openapi3.Operation, r *request) {
	req := openapi3.NewRequestBody()
	req.Content = doc.newContents(r.schema, r.media...)
...
func (doc *Parser) addResponses(o *openapi3.Operation, resps map[string]*response) {
	for status, r := range resps {
		resp := openapi3.NewResponse()
		resp.Description = &r.desc
		resp.Content = doc.newContents(r.schema, r.media...)
...
func (doc *Parser) newContents(s *openapi3.SchemaRef, media ...string) openapi3.Content {
