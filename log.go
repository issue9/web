...
func INFO() *log.Logger {
	return Server().Builder().Logs().INFO()
}
...
func DEBUG() *log.Logger {
	return Server().Builder().Logs().DEBUG()
}
...
func TRACE() *log.Logger {
	return Server().Builder().Logs().TRACE()
}
...
func WARN() *log.Logger {
	return Server().Builder().Logs().WARN()
}
...
func ERROR() *log.Logger {
	return Server().Builder().Logs().ERROR()
}
...
func CRITICAL() *log.Logger {
	return Server().Builder().Logs().CRITICAL()
}
