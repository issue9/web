...
func TestMain(m *testing.M) {
	if err := mimetype.AddMarshal(mimetype.DefaultMimetype, mimetypetest.TextMarshal); err != nil {
		panic(err)
	}

	if err := mimetype.AddUnmarshal(mimetype.DefaultMimetype, mimetypetest.TextUnmarshal); err != nil {
		panic(err)
	}
